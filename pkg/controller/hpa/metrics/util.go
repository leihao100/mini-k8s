...
//func GetResourceUtilizationRatio(metrics ConatinerMetricsInfo, ty ResourceType, requests map[uuid.UUID]int64, targetUtilization int32) (utilizationRatio float64, currentUtilization int32, rawAverageValue int64, err error) {
...
//func GetMetricUsageRatio(metrics ConatinerMetricsInfo, ty ResourceType, targetUsage int64) (usageRatio float64, currentUsage int64) {
//	metricsTotal := int64(0)
